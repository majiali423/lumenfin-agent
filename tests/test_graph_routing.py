...
def build_test_config(root: Path) -> AppConfig:
    ...
    return AppConfig(
        ...
        port=8000,
        api_key=None,
        api_key_client_id="default-client",
        api_key_tenant_id="test-tenant",
        ...
        rag_rerank_timeout_seconds=12.0,
        rag_rerank_max_attempts=2,
        rag_rerank_backoff_seconds=0.25,
        rag_rerank_max_inflight_per_process=2,
        rag_rerank_max_document_chars=4000,

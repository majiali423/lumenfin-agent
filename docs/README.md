...
| [STRUCTURED_ANSWER.md](STRUCTURED_ANSWER.md) | Structured answer + verified chunk-id citation protocol (`1.0`); synthetic canary and recorded public/dev shadow are not accuracy claims |

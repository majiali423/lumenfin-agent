...
| [STRUCTURED_ANSWER.md](STRUCTURED_ANSWER.md) | Structured answer + verified chunk-id citation protocol (`1.0`); synthetic canary, recorded public/dev shadow, and synthetic alias-compliance canary (not run) are not accuracy claims |

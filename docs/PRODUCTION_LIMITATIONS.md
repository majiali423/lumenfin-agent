...
- Controlled synthetic DeepSeek/DashScope/Qwen3 smoke passed locally on
  ...
  The post-tag `main` Linux-image regression on 2026-08-13 passed 511 tests
...
| Post-tag LumenFin regression | PASS (2026-08-13) — current `main` Linux-image suite 511/3 skip | local closure run; not part of immutable `v0.1.0-rc.3` evidence |

...
| [STRUCTURED_ANSWER.md](STRUCTURED_ANSWER.md) | Structured answer / verified chunk-id citations (`1.0`); synthetic canary, public/dev shadow, and synthetic alias-compliance canary are not accuracy claims |
